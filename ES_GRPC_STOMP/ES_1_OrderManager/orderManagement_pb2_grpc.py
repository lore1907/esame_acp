...
class OrderManagerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.addOrder = channel.unary_unary(
                '/order_managemet.OrderManager/addOrder',
        ...
        self.getOrder = channel.unary_unary(
                '/order_managemet.OrderManager/getOrder',
        ...
        self.searchOrders = channel.unary_stream(
                '/order_managemet.OrderManager/searchOrders',
                request_serializer=orderManagement__pb2.StringMessage.SerializeToString,
                response_deserializer=orderManagement__pb2.Order.FromString,
                _registered_method=True)
        self.processOrders = channel.stream_stream(
                '/order_managemet.OrderManager/processOrders',
                request_serializer=orderManagement__pb2.Order.SerializeToString,
...
def add_OrderManagerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'order_managemet.OrderManager', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('order_managemet.OrderManager', rpc_method_handlers)
