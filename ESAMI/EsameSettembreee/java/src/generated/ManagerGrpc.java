...
public final class ManagerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<generated.DeployReq,
      generated.Empty> getDeployMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Deploy",
      requestType = generated.DeployReq.class,
      responseType = generated.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<generated.DeployReq,
      generated.Empty> getDeployMethod() {
    io.grpc.MethodDescriptor<generated.DeployReq, generated.Empty> getDeployMethod;
      ...
      synchronized (ManagerGrpc.class) {
        if ((getDeployMethod = ManagerGrpc.getDeployMethod) == null) {
          ManagerGrpc.getDeployMethod = getDeployMethod =
              io.grpc.MethodDescriptor.<generated.DeployReq, generated.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Deploy"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.DeployReq.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<generated.StopReq,
      generated.Empty> getStopAllMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StopAll",
      requestType = generated.StopReq.class,
      responseType = generated.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<generated.StopReq,
      generated.Empty> getStopAllMethod() {
    io.grpc.MethodDescriptor<generated.StopReq, generated.Empty> getStopAllMethod;
    if ((getStopAllMethod = ManagerGrpc.getStopAllMethod) == null) {
      synchronized (ManagerGrpc.class) {
        if ((getStopAllMethod = ManagerGrpc.getStopAllMethod) == null) {
          ManagerGrpc.getStopAllMethod = getStopAllMethod =
              io.grpc.MethodDescriptor.<generated.StopReq, generated.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "StopAll"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.StopReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.Empty.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void deploy(generated.DeployReq request,
    ...
    /**
     */
    default void stopAll(generated.StopReq request,
        io.grpc.stub.StreamObserver<generated.Empty> responseObserver) {
  ...
  public static final class ManagerStub
    ...
    /**
     */
    public void deploy(generated.DeployReq request,
        io.grpc.stub.StreamObserver<generated.Empty> responseObserver) {
    ...
    /**
     */
    public void stopAll(generated.StopReq request,
        io.grpc.stub.StreamObserver<generated.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class ManagerBlockingV2Stub
    ...
    /**
     */
    public generated.Empty deploy(generated.DeployReq request) {
    ...
    /**
     */
    public generated.Empty stopAll(generated.StopReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DEPLOY:
          serviceImpl.deploy((generated.DeployReq) request,
              (io.grpc.stub.StreamObserver<generated.Empty>) responseObserver);
          break;
        case METHODID_STOP_ALL:
          serviceImpl.stopAll((generated.StopReq) request,
              (io.grpc.stub.StreamObserver<generated.Empty>) responseObserver);
          break;
        default:
