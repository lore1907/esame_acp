...
public final class ManagerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<generated.StopRequest,
      generated.Empty> getStopAllMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StopAll",
      requestType = generated.StopRequest.class,
      responseType = generated.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<generated.StopRequest,
      generated.Empty> getStopAllMethod() {
    io.grpc.MethodDescriptor<generated.StopRequest, generated.Empty> getStopAllMethod;
      ...
      synchronized (ManagerGrpc.class) {
        if ((getStopAllMethod = ManagerGrpc.getStopAllMethod) == null) {
          ManagerGrpc.getStopAllMethod = getStopAllMethod =
              io.grpc.MethodDescriptor.<generated.StopRequest, generated.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "StopAll"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.StopRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<generated.DeployRequest,
      generated.Empty> getDeployMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Deploy",
      requestType = generated.DeployRequest.class,
      responseType = generated.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<generated.DeployRequest,
      generated.Empty> getDeployMethod() {
    io.grpc.MethodDescriptor<generated.DeployRequest, generated.Empty> getDeployMethod;
    if ((getDeployMethod = ManagerGrpc.getDeployMethod) == null) {
      synchronized (ManagerGrpc.class) {
        if ((getDeployMethod = ManagerGrpc.getDeployMethod) == null) {
          ManagerGrpc.getDeployMethod = getDeployMethod =
              io.grpc.MethodDescriptor.<generated.DeployRequest, generated.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Deploy"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.DeployRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.Empty.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void stopAll(generated.StopRequest request,
    ...
    /**
     */
    default void deploy(generated.DeployRequest request,
        io.grpc.stub.StreamObserver<generated.Empty> responseObserver) {
  ...
  public static final class ManagerStub
    ...
    /**
     */
    public void stopAll(generated.StopRequest request,
        io.grpc.stub.StreamObserver<generated.Empty> responseObserver) {
    ...
    /**
     */
    public void deploy(generated.DeployRequest request,
        io.grpc.stub.StreamObserver<generated.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class ManagerBlockingV2Stub
    ...
    /**
     */
    public generated.Empty stopAll(generated.StopRequest request) {
    ...
    /**
     */
    public generated.Empty deploy(generated.DeployRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ManagerFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<generated.Empty> deploy(
        generated.DeployRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getDeployMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_STOP_ALL = 0;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_STOP_ALL:
          serviceImpl.stopAll((generated.StopRequest) request,
              (io.grpc.stub.StreamObserver<generated.Empty>) responseObserver);
          break;
        case METHODID_DEPLOY:
          serviceImpl.deploy((generated.DeployRequest) request,
              (io.grpc.stub.StreamObserver<generated.Empty>) responseObserver);
          break;
        default:
