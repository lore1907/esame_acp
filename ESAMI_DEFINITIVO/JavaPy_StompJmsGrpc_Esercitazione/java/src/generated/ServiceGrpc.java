...
@javax.annotation.Generated(
    ...
    comments = "Source: protos/service.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class ServiceGrpc {

  private ServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "generated.Service";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<generated.Empty,
      generated.Product> getPrelevaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Preleva",
      requestType = generated.Empty.class,
      responseType = generated.Product.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<generated.Empty,
      generated.Product> getPrelevaMethod() {
    io.grpc.MethodDescriptor<generated.Empty, generated.Product> getPrelevaMethod;
    if ((getPrelevaMethod = ServiceGrpc.getPrelevaMethod) == null) {
      synchronized (ServiceGrpc.class) {
        if ((getPrelevaMethod = ServiceGrpc.getPrelevaMethod) == null) {
          ServiceGrpc.getPrelevaMethod = getPrelevaMethod =
              io.grpc.MethodDescriptor.<generated.Empty, generated.Product>newBuilder()
              ...
              .setSchemaDescriptor(new ServiceMethodDescriptorSupplier("Preleva"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<generated.Product,
      generated.Empty> getDepositaMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Deposita",
      requestType = generated.Product.class,
      responseType = generated.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<generated.Product,
      generated.Empty> getDepositaMethod() {
    io.grpc.MethodDescriptor<generated.Product, generated.Empty> getDepositaMethod;
    if ((getDepositaMethod = ServiceGrpc.getDepositaMethod) == null) {
      synchronized (ServiceGrpc.class) {
        if ((getDepositaMethod = ServiceGrpc.getDepositaMethod) == null) {
          ServiceGrpc.getDepositaMethod = getDepositaMethod =
              io.grpc.MethodDescriptor.<generated.Product, generated.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  generated.Empty.getDefaultInstance()))
              .setSchemaDescriptor(new ServiceMethodDescriptorSupplier("Deposita"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void preleva(generated.Empty request,
        io.grpc.stub.StreamObserver<generated.Product> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getPrelevaMethod(), responseObserver);
    }

    /**
     */
    default void deposita(generated.Product request,
  ...
  public static final class ServiceStub
    ...
    /**
     */
    public void preleva(generated.Empty request,
        io.grpc.stub.StreamObserver<generated.Product> responseObserver) {
    ...
    /**
     */
    public void deposita(generated.Product request,
        io.grpc.stub.StreamObserver<generated.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class ServiceBlockingV2Stub
    ...
    /**
     */
    public generated.Product preleva(generated.Empty request) {
    ...
    /**
     */
    public generated.Empty deposita(generated.Product request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<generated.Product> preleva(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<generated.Empty> deposita(
        generated.Product request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getDepositaMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_PRELEVA = 0;
  private static final int METHODID_DEPOSITA = 1;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PRELEVA:
          serviceImpl.preleva((generated.Empty) request,
              (io.grpc.stub.StreamObserver<generated.Product>) responseObserver);
          break;
        case METHODID_DEPOSITA:
          serviceImpl.deposita((generated.Product) request,
              (io.grpc.stub.StreamObserver<generated.Empty>) responseObserver);
          break;
        default:
  ...
  private static abstract class ServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return generated.ServiceOuterClass.getDescriptor();
    }
